...
function InfoFilm(props) {
  ...
  return (
    <div className='box_infofilm'>
      <div>
        {
          // console.log(props.apiFilmsDayTime.lsApiFilmId[0])
                      ...
                      <div className='inCardFilms'>
                        ...
                        <div className='QuocGia'>
                          <div className='left'>
                            ...
                            <div className='comment_film'>
                              <button onClick={() => { SetComment(!cmt) }}>{cmt?<p>Ẩn bình luận</p>:<p>Xem bình luận</p>}</button>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className='body_content_cinema'>
        ...
        <div className='gioChieu'>
          ...
          <div className='allTime_oneDay_film'>
            {props.NowSoonFilms.lsNowSoon &&
              IndexChain &&
              props.NowSoonFilms.lsNowSoon.Cinemas.Items.map((n, i) => {
                return (
                  ...
                  <div  key={i + '1312431241'}>
                    {/* {console.log(n.VersionsCaptions[0].ShowTimes)} */}
                    {
